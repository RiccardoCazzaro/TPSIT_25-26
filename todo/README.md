...
- Tutti i Todo sono visualizzati come card verticali
- Tap sul testo per modificarlo direttamente (TextField)
...
- **TextFormField inline per il testo dei Todo**(al posto del TextField): mancanza di controller manuali
